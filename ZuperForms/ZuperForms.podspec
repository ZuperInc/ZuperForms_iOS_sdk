...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/ZupersoftSolutions/ZuperForms_iOS_sdk"
  ...
  spec.source       = { :git => "https://github.com/ZupersoftSolutions/ZuperForms_iOS_sdk.git", :tag => "#{spec.version}" }
  ...
  spec.resource_bundle = {
    'ZuperFormsAssets' => ['ZuperForms/**/*.{png,storyboard,xib,gif,xcassets}']
  }
